  ...
  const submitOrder = async (event) => {
    ...
    const payload = {
      ...
      items: cartItems.map((item) => ({
        ...
        price: item.price ?? item.snapshot?.price,
        collectionSlug: item.collectionSlug,
        productSlugs: item.productSlugs,
        products: item.products ?? item.snapshot?.products,
        roomSlugs: item.roomSlugs ?? item.snapshot?.roomSlugs,
        categorySlug: item.categorySlug ?? item.snapshot?.categorySlug,
        type: item.type ?? item.snapshot?.type,
        gallery: item.gallery ?? item.snapshot?.gallery,
