...
export const api = {
  ...
  adminRestavrationPage: () => apiRequest('/admin/restavration'),
  updateAdminRestavrationPage: (payload) => apiRequest('/admin/restavration', { method: 'PATCH', body: JSON.stringify(payload) }),
